...
function Navbar() {
  ...
  return (
    <div className='w-full h-22 absolute z-10 '>
      ...
      <nav className=' w-[70%] h-full items-center mx-auto gap-[550px] flex '>
        ...
        <div className=' flex gap-3'>
          <div>{location.pathname === "/" && !user && (
            <div className='w-32 h-9 gap-16 bg-black/30 bg  flex justify-center relative items-center rounded-sm focus:ring-1 focus:border-2'>
