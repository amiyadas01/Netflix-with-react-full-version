...
useEffect(()=>{
  ...
  >
    ...
    <div className=" relative">{children? children  : <div className=" absolute md:left-25 md:top-45 2xl:top-60 2xl:left-50 left-10 top-40 z-20"> 
      <div className=" text-lg md:text-5xl 2xl:text-7xl font-extrabold text-white">{movie.title}</div>
          <div className=" max-w-[350px]  md:max-w-[450px] 2xl:max-w-[800px] 2xl:text-[20px] text-[#f0f0f0] mt-3 md:mt-5">{textCutter( movie.overview, 100)}</div> 
