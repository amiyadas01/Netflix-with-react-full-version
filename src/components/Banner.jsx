...
useEffect(()=>{
  ...
  >
    ...
    <div className=" relative">{children? children  : <div className=" absolute md:left-25 md:top-45 left-10 top-40 z-20"> 
      <div className=" text-lg md:text-5xl font-extrabold text-stone-400">{movie.title}</div>
          <div className=" max-w-[350px]  md:max-w-[450px] text-[#aeaeaeb1] mt-3 md:mt-5">{textCutter( movie.overview, 100)}</div> 
          <div className="md:text-md text-sm text-gray-400 mt-2.5 md:mt-5 gap-8 flex">
            ...
            <div className=" md:flex md:items-center gap-5 md:justify-center">
              {/* <img width="40px" height="20px" className=" brightness-80" src="public\youtube.png" alt="" /> */}
               <button className=" w-20 md:w-30 h-9 md:h-12 cursor-pointer rounded-md text-black hover:bg-stone-300/85 hover:text-gray-950 bg-stone-400" onClick={ () => {
              SetShowTrailer(true)
