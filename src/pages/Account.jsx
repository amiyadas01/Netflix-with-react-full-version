...
function Account() {
  ...
  return (
    ...
    <div className=" absolute left-20 top-45 z-20">
      <div className=" text-3xl font-extrabold text-white"> Account Details </div>
    <div className=" text-3xl mt-10 font-extrabold gap-4 flex flex-row"><div>Email :</div> <div className="text-stone-400">{user.email}</div></div>
    </div>
    </div>
  )
}
