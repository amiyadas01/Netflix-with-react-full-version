...
function Account() {
  ...
  return (
    <div><div className="m-0 relative">
          ...
          <Banner category ="/discover/movie?with_genres=28,12,878" className="2xl:h-[70vh]" > <div></div></Banner>
    ...
    <div className=" absolute left-10 top-28 md:left-20 2xl:left-40 md:top-45 2xl:top-60 z-20">
